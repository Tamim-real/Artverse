...
const ArtworkDetails = () => {
  ...
  return (
    <div className="min-h-screen py-24 px-4 sm:px-6 md:px-10 flex flex-col items-center bg-gray-100 dark:bg-gray-900 transition-colors duration-300">
      ...
      <motion.button
        onClick={() => navigate(-1)}
        className="mt-10 flex items-center gap-2 bg-gray-300 text-black px-6 py-3 rounded-2xl shadow-lg hover:shadow-cyan-500/40 hover:scale-105 transition-all duration-300 text-sm sm:text-base"
        whileHover={{ y: -3 }}
      >
